...
export type TokensTypeFragment = { __typename?: 'Tokens', access_token: string, refresh_token: string };
...
export type CreateCategoryMutation = { __typename?: 'Mutation', createCategory: { __typename?: 'Category', id: string, title: string, authorId: string } };
...
export type DeleteCategoryMutation = { __typename?: 'Mutation', removeCategory?: { __typename?: 'Category', id: string, title: string, authorId: string } | null };

export type CategoryTypeFragment = { __typename?: 'Category', id: string, title: string, authorId: string };

export type GetCategoriesQueryVariables = Exact<{ [key: string]: never; }>;


export type GetCategoriesQuery = { __typename?: 'Query', categories: Array<{ __typename?: 'Category', id: string, title: string, authorId: string } | null> };
...
export type CreateTransactionMutation = { __typename?: 'Mutation', createTransactionRecord: { __typename?: 'TransactionRecord', id: string, amount: number, authorId: string, categoryId: string, date: string, description?: string | null, title: string, type?: TransactionType | null } };
...
export type DeleteTransactionMutation = { __typename?: 'Mutation', removeTransactionRecord?: { __typename?: 'TransactionRecord', id: string, amount: number, authorId: string, categoryId: string, date: string, description?: string | null, title: string, type?: TransactionType | null } | null };

export type TransactionRecordTypeFragment = { __typename?: 'TransactionRecord', id: string, amount: number, authorId: string, categoryId: string, date: string, description?: string | null, title: string, type?: TransactionType | null };

export type GetTransactionsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetTransactionsQuery = { __typename?: 'Query', transactionRecords: Array<{ __typename?: 'TransactionRecord', id: string, amount: number, authorId: string, categoryId: string, date: string, description?: string | null, title: string, type?: TransactionType | null } | null> };
